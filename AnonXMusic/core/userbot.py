...
class Userbot(Client):
    ...
    async def start(self):
        LOGGER(__name__).info(f"αѕѕιѕтαит ѕтαятє∂......... 🎖️")
        if config.STRING1:
        ...
        if config.STRING2:
            ...
            assistants.append(2)
            try:
                await self.two.send_message(config.LOGGER_ID, "αѕѕιѕтαит ѕтαятє∂......... 🎖️")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING3:
            ...
            assistants.append(3)
            try:
                await self.three.send_message(config.LOGGER_ID, "αѕѕιѕтαит ѕтαятє∂......... 🎖️")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING4:
            ...
            assistants.append(4)
            try:
                await self.four.send_message(config.LOGGER_ID, "αѕѕιѕтαит ѕтαятє∂......... 🎖️")
            except:
                LOGGER(__name__).error(
